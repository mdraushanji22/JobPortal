        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <form method="GET" action="{{ route('candidate.jobs.index') }}">
                <div class="space-y-3">
                    ...
                    <a href="{{ route('candidate.jobs.index') }}" class="block text-center text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">Clear Filters</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="lg:col-span-3">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-4 hover:shadow-lg transition">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-xl font-semibold"><a href="{{ route('candidate.jobs.show', $job) }}" class="text-gray-800 dark:text-white hover:text-blue-600 dark:hover:text-blue-400">{{ $job->title }}</a></h3>
