            ...
            <tr>
                ...
                <td class="px-6 py-4">
                    <div class="flex space-x-2">
                        <a href="{{ route('admin.candidates.show', $candidate) }}" class="text-blue-600 hover:text-blue-800"><i class="fas fa-eye"></i></a>
                        <a href="{{ route('admin.candidates.edit', $candidate) }}" class="text-yellow-600 hover:text-yellow-800"><i class="fas fa-edit"></i></a>
