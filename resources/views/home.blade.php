    ...
    <div class="max-w-7xl mx-auto px-4 text-center">
        ...
        <form action="{{ route('jobs.index') }}" method="GET" class="max-w-3xl mx-auto">
            <div class="flex gap-2 bg-white dark:bg-gray-800 rounded-lg p-2 shadow-lg">
                <input type="text" name="search" placeholder="Search jobs, skills, companies..." class="flex-1 px-4 py-3 text-gray-800 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 rounded focus:outline-none">
